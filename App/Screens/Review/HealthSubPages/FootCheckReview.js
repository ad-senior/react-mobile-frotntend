...
class BloodTestReview extends Component {
  ...
  _loadPositions = () => {
    ...
    if (data.weight_foot != '') {
      ...
      if (data.treatment_foot != '') {
        ...
        this.positions[4] = "kg. Reason for treatment is because "
      ...
      if (data.treatment_foot != '') {
        ...
        this.positions[3] = ". Reason for treatment is because "
        if (data.notes_and_thoughts) {
          this.positions[4] = ". "
          this.positions[5] = ". The mood was "
          this.positions[6] = ". "
  ...
  _loadKeywords = () => {
    ...
    if (data.weight_foot != '') {
      ...
      this.keyWords[3] = data.weight_foot
      if (data.treatment_foot != '') {
        this.keyWords[4] = data.treatment_foot
        this.keyWords[5] = data.reason_treatment_foot
        if (data.notes_and_thoughts) {
        ...
        this.keyWords[4] = data.reason_treatment_foot
        if (data.notes_and_thoughts) {
      ...
      if (data.treatment_foot != '') {
        this.keyWords[3] = data.treatment_foot
        this.keyWords[4] = data.reason_treatment_foot
        if (data.notes_and_thoughts) {
          this.keyWords[5] = data.notes_and_thoughts
          if (data.mood_2) {
        ...
        this.keyWords[3] = data.reason_treatment_foot
        if (data.notes_and_thoughts) {
