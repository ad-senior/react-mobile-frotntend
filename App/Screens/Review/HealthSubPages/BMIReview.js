...
class BloodTestReview extends Component {
      ...
      if (data.heightbmi != emptyString) {
          ...
          if (data.weightbmi != emptyString) {
              ...
              if (data.notes_and_thoughts) {
                  this.positions[6] = data.measurement_system == Data.healthBMIChoices[0].value ? "lb." : "kg. ";
                  this.positions[7] = ". The mood was ";
                  this.positions[8] = ". ";
              }
              else {
                  this.positions[6] = data.measurement_system == Data.healthBMIChoices[0].value ? "lb. The mood was " : "kg. The mood was ";
                  this.positions[7] = ". ";
              }
          } else {
              if (data.notes_and_thoughts) {
                  this.positions[5] = data.measurement_system == Data.healthBMIChoices[0].value ? "ft. " : "cm. ";
                  this.positions[6] = ". The mood was ";
                  this.positions[7] = ". ";
              }
              else {
                  this.positions[5] = data.measurement_system == Data.healthBMIChoices[0].value ? "ft. The mood was " : "cm. The mood was ";
                  this.positions[6] = ". ";
              }
          }
          ...
          if (data.weightbmi != emptyString) {
              ...
              if (data.notes_and_thoughts) {
                  ...
                  this.positions[5] = data.measurement_system == Data.healthBMIChoices[0].value ? "lb. The mood was " : "kg. The mood was ";
                  this.positions[6] = ". ";
              }
          } else {
              if (data.notes_and_thoughts) {
  ...
  _loadKeywords = () => {
      ...
      if (data.heightbmi != emptyString) {
          ...
          this.keyWords[4] = data.heightbmi;
          if (data.weightbmi != emptyString) {
              this.keyWords[5] = data.weightbmi;
              if (data.notes_and_thoughts) {
