...
class BloodTestReview extends Component {
  ...
  _loadPositions = () => {
      ...
      if (data.blood_test_result == emptyString) {
          ...
          this.positions[4] = " reffered. The test result was ";
          this.positions[5] = " and the reason for the test was ";
          if (data.notes_and_thoughts) {
              this.positions[6] = ". ";
  ...
  _loadKeywords = () => {
      ...
      if (data.blood_test_result == emptyString) {
          ...
          this.keyWords[4] = data.blood_test_result.toLowerCase();
          this.keyWords[5] = data.blood_test_reason.toLowerCase();
          if (data.notes_and_thoughts) {
